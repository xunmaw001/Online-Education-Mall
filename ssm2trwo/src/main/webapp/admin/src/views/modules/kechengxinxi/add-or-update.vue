<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'&& !ro.kechengshipin" label="课程视频" prop="kechengshipin">
          <file-upload
          tip="点击上传课程视频"
          action="file/upload"
          :limit="1"
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="重点难点" prop="zhongdiannandian">
          <el-input v-model="ruleForm.zhongdiannandian" 
              placeholder="重点难点" clearable  :readonly="ro.zhongdiannandian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="重点难点" prop="zhongdiannandian">
              <el-input v-model="ruleForm.zhongdiannandian" 
                placeholder="重点难点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
	...
	this.ruleForm.kechengneirong = this.ruleForm.kechengneirong.replace(reg,'../../../ssm2trwo/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
