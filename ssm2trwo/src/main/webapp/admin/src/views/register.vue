  ...
  <div>
      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<el-form-item label="联系手机" class="input" v-if="tableName=='jiaoshi'">
 ...
 //  }
	...
	.container {
		...
		background-repeat: no-repeat;
    				background-image: url(http://codegen.caihongy.cn/20220121/0e0626a393954d09ba659fc4f23d21de.png);
      ...
      box-sizing: border-box;
        ...
        .send-code {
          ...
          line-height:44px;
					...
					border-color: rgba(75, 101, 83, 1);
					border-radius: 4px;
					background-color: rgba(75, 101, 83, 1);
          box-shadow: 0 0 6px rgba(255,0,0,0);
				}
